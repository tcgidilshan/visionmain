...
from .channel_views import ChannelAppointmentView,ChannelListView,AppointmentRetrieveUpdateDeleteView,DoctorScheduleTransferView,DoctorAppointmentTransferView,DoctorAppointmentTimeListView,ChannelUpdateView,CancelChannelView
